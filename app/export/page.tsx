...
const TABS = [
  { id: 'new',       label: 'เนเธเธเน€เธชเธทเนเธญเนเธซเธกเน',     badge: 'New',  isPromo: false },
  { id: 'collar',    label: 'เธเธญเน€เธชเธทเนเธญเธ—เธฑเนเธเธซเธกเธ”',   badge: '',     isPromo: false },
  { id: 'promotion', label: 'เนเธเธฃเนเธกเธเธฑเนเธ',          badge: '',     isPromo: true  },
  { id: 'other',     label: 'เนเธเธเน€เธชเธทเนเธญเธญเธทเนเธเน',    badge: '',     isPromo: false },
  { id: 'fabric',    label: 'เน€เธเธทเนเธญเธเนเธฒ',           badge: '',     isPromo: false },
  { id: 'photo',     label: 'เธ เธฒเธเธ–เนเธฒเธขเธเธฒเธเธเธฃเธดเธ',   badge: '',     isPromo: false },
  { id: 'all',       label: 'เธชเธดเธเธเนเธฒเธ—เธฑเนเธเธซเธกเธ”',     badge: '',     isPromo: false },
]

const LAYOUTS = [
  { id: 'auto', label: 'Auto' },
  { id: '2col', label: '2 เธเธญเธฅเธฑเธกเธเน' },
  { id: '3col', label: '3 เธเธญเธฅเธฑเธกเธเน' },
  { id: '4col', label: '4 เธเธญเธฅเธฑเธกเธเน' },
]

const SIZES = [
  { id: '9:16', label: '9:16 Stories', w: 1080, h: 1920, icon: '๐“ฑ' },
  { id: '1:1',  label: '1:1 Square',   w: 1080, h: 1080, icon: 'โฌ' },
  { id: '16:9', label: '16:9 Wide',    w: 1920, h: 1080, icon: '๐–ฅ' },
  { id: '4:5',  label: '4:5 Portrait', w: 1080, h: 1350, icon: '๐“ท' },
]
...
export default function ExportPage() {
  ...
  const [title, setTitle] = useState('เธเธญเน€เธชเธทเนเธญเนเธฅเธฐเธชเธดเธเธเนเธฒเธ—เธฑเนเธเธซเธกเธ”')
  const [subtitle, setSubtitle] = useState('Collar and All Product.')
  const [brandText, setBrandText] = useState('FB : เน€เธชเธทเนเธญเธเธตเธฌเธฒเธเธดเธกเธเนเธฅเธฒเธข EVO SPORT เธเธญเธเนเธเนเธ')
  ...
  const doExport = useCallback(async () => {
    ...
    setExporting(true)
    setProgress('เธเธณเธฅเธฑเธเนเธซเธฅเธ”เธฃเธนเธเธ เธฒเธ...')
    ...
    const imgs = await Promise.all(items.map((s, i) => {
      setProgress(`เนเธซเธฅเธ”เธฃเธนเธ ${i + 1}/${items.length}...`)
      return loadImg(s.image_url)
    }))
    const logoImg = logoSrc ? await loadImg(logoSrc) : null

    setProgress('เธเธณเธฅเธฑเธเธงเธฒเธ”เธ เธฒเธ...')
    ...
    items.forEach((shirt, i) => {
      ...
      if (img) {
        ...
        ctx.fillText('๐‘•', x + cardW / 2, y + imgH / 2 + imgH * 0.08)
      }
      ctx.restore()
      ...
      if (showName || showPrice) {
        ...
        if (showName && shirt.name) {
          ...
          const nm = shirt.name.length > 16 ? shirt.name.slice(0, 15) + 'โ€ฆ' : shirt.name
    ...
    setProgress('เธเธณเธฅเธฑเธเธเธฑเธเธ—เธถเธเนเธเธฅเน...')
    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0a', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Noto Sans Thai','Sarabun',sans-serif" }}>
      ...
      <div style={{ background: '#111', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 14, padding: '36px 32px', width: '100%', maxWidth: 380 }}>
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          ...
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.3)', marginTop: 4 }}>เน€เธเนเธฒเธชเธนเนเธฃเธฐเธเธ Admin เน€เธเธทเนเธญเนเธเนเธเธฒเธ</div>
        </div>
        <input className="inp" placeholder="Name ID เน€เธเนเธ ceo edit00" value={loginId} onChange={e => setLoginId(e.target.value)} />
        <input className="inp" type="password" placeholder="Password" value={loginPw} onChange={e => setLoginPw(e.target.value)}
          onKeyDown={e => { if (e.key === 'Enter') { if (ADMIN_ACCOUNTS[loginId] === loginPw) { setAdminUser(loginId); setLoginErr('') } else setLoginErr('เธเธทเนเธญเธเธนเนเนเธเนเธซเธฃเธทเธญเธฃเธซเธฑเธชเธเนเธฒเธเนเธกเนเธ–เธนเธเธ•เนเธญเธ') } }} />
        ...
        <button style={{ width: '100%', background: '#c00', color: '#fff', border: 'none', padding: '11px', borderRadius: 5, cursor: 'pointer', fontFamily: 'inherit', fontWeight: 700, fontSize: 14 }}
          onClick={() => { if (ADMIN_ACCOUNTS[loginId] === loginPw) { setAdminUser(loginId); setLoginErr('') } else setLoginErr('เธเธทเนเธญเธเธนเนเนเธเนเธซเธฃเธทเธญเธฃเธซเธฑเธชเธเนเธฒเธเนเธกเนเธ–เธนเธเธ•เนเธญเธ') }}>
          เน€เธเนเธฒเธชเธนเนเธฃเธฐเธเธ
        </button>
        <div style={{ marginTop: 14, textAlign: 'center' }}>
          <a href="/catalog" style={{ fontSize: 12, color: 'rgba(255,255,255,0.3)', textDecoration: 'none' }}>โ เธเธฅเธฑเธเธซเธเนเธฒเธซเธฅเธฑเธ</a>
        </div>
      </div>
    </div>
  )
      ...
      <div style={{ background: '#0d0d0d', borderBottom: '1px solid rgba(255,255,255,0.07)', padding: '0 20px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 56 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <a href="/catalog" style={{ color: 'rgba(255,255,255,0.4)', fontSize: 12, textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 4 }}>โ เธเธฅเธฑเธ</a>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <button className="btn-o" style={{ padding: '4px 10px', fontSize: 11 }} onClick={() => setAdminUser(null)}>เธญเธญเธ</button>
          </div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '20px 16px' }}>
        <div className="main-layout" style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: 20, alignItems: 'start' }}>
            ...
            <div style={{ background: '#111', borderRadius: 8, border: '1px solid rgba(255,255,255,0.07)', marginBottom: 14, overflowX: 'auto' }}>
              <div style={{ display: 'flex', minWidth: 'max-content' }}>
                ...
                <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 6, padding: '0 10px' }}>
                  <button className="btn-o" onClick={() => setSelected(new Set(shirts.map(s => s.id)))} style={{ padding: '3px 10px', fontSize: 10 }}>เน€เธฅเธทเธญเธเธ—เธฑเนเธเธซเธกเธ”</button>
                  <button className="btn-o" onClick={() => setSelected(new Set())} style={{ padding: '3px 10px', fontSize: 10 }}>เธขเธเน€เธฅเธดเธ</button>
                </div>
              </div>
            </div>

            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12, fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>
              <span>เธ—เธฑเนเธเธซเธกเธ” <b style={{ color: '#fff' }}>{shirts.length}</b></span>
              <span style={{ color: 'rgba(255,255,255,0.15)' }}>|</span>
              <span>เน€เธฅเธทเธญเธ <b style={{ color: '#c00' }}>{selected.size}</b></span>
              {selected.size > 0 && <span style={{ color: 'rgba(255,255,255,0.3)' }}>{getCols(selected.size)} เธเธญเธฅเธฑเธกเธเน ยท {Math.ceil(selected.size / getCols(selected.size))} เนเธ–เธง</span>}
            </div>

            {loading ? (
              <div style={{ textAlign: 'center', padding: '60px 0', color: 'rgba(255,255,255,0.2)' }}>เธเธณเธฅเธฑเธเนเธซเธฅเธ”...</div>
            ) : shirts.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '60px 0', color: 'rgba(255,255,255,0.2)' }}>เนเธกเนเธกเธตเธชเธดเธเธเนเธฒเนเธเธซเธกเธงเธ”เธเธตเน</div>
            ) : (
              <div className="grid">
                {shirts.map(s => (
                  <div key={s.id} className={`card${selected.has(s.id) ? ' sel' : ''}`} onClick={() => toggle(s.id)}>
                    <div className="chk">{selected.has(s.id) ? 'โ“' : ''}</div>
                    <div style={{ aspectRatio: '1', background: '#1a1a1a', overflow: 'hidden' }}>
                      {s.image_url
                        ...
                        : <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 28, color: 'rgba(255,255,255,0.1)' }}>๐‘•</div>
                      }
                    </div>
                    <div style={{ padding: '9px 10px' }}>
                      <div style={{ fontWeight: 600, fontSize: 11, color: '#fff', marginBottom: 2, lineHeight: 1.3 }}>{s.name || 'เนเธกเนเธกเธตเธเธทเนเธญ'}</div>
                      {s.collar_type && <div style={{ fontSize: 9, color: 'rgba(255,255,255,0.3)', marginBottom: 2 }}>เธเธญ: {s.collar_type}</div>}
                      <div style={{ fontWeight: 700, fontSize: 12, color: '#ff4444' }}>{s.price ? `${Number(s.price).toLocaleString()} THB.-` : 'โ€”'}</div>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div style={{ background: '#111', border: '1px solid rgba(255,255,255,0.09)', borderRadius: 10, padding: '18px 16px', position: 'sticky', top: 16, display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div style={{ fontWeight: 700, fontSize: 14, color: '#fff', borderBottom: '1px solid rgba(255,255,255,0.07)', paddingBottom: 10 }}>โ เธ•เธฑเนเธเธเนเธฒเธ เธฒเธ</div>

            <div>
              <div className="sl">เธเธเธฒเธ”เธ เธฒเธ</div>
            ...
            <div>
              <div className="sl">Layout เธเธญเธฅเธฑเธกเธเน</div>
            ...
            <div><div className="sl">เธเธทเนเธญเธซเธฑเธง</div><input className="inp" value={title} onChange={e => setTitle(e.target.value)} /></div>
            <div><div className="sl">เธเธฑเธเนเธ•เน€เธ•เธดเธฅ</div><input className="inp" value={subtitle} onChange={e => setSubtitle(e.target.value)} /></div>
            <div><div className="sl">เธเนเธญเธเธงเธฒเธกเธ—เนเธฒเธข</div><input className="inp" value={brandText} onChange={e => setBrandText(e.target.value)} /></div>
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                ...
                <label style={{ flex: 1, background: '#1a1a1a', border: '1px dashed rgba(200,0,0,0.4)', borderRadius: 5, padding: '7px 10px', cursor: 'pointer', fontSize: 11, color: 'rgba(255,255,255,0.4)', textAlign: 'center', display: 'block' }}>
                  {logoSrc ? 'เน€เธเธฅเธตเนเธขเธ Logo' : '+ เธญเธฑเธเนเธซเธฅเธ” Logo'}
                ...
                {logoSrc && <button className="btn-o" style={{ padding: '5px 8px', fontSize: 10 }} onClick={() => setLogoSrc(null)}>เธฅเธ</button>}
              </div>
            </div>

            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
              <div>
                <div className="sl">เธชเธตเธซเธฅเธฑเธ</div>
              ...
              <div>
                <div className="sl">เธเธทเนเธเธซเธฅเธฑเธ</div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            <div style={{ background: '#1a1a1a', borderRadius: 7, padding: '10px 12px', display: 'flex', flexDirection: 'column', gap: 8 }}>
              <div className="sl" style={{ marginBottom: 0 }}>เนเธชเธ”เธเนเธเธ เธฒเธ</div>
              <label className="tog"><input type="checkbox" checked={showNumbers} onChange={e => setShowNumbers(e.target.checked)} /> เน€เธฅเธเธฅเธณเธ”เธฑเธ</label>
              <label className="tog"><input type="checkbox" checked={showPrice} onChange={e => setShowPrice(e.target.checked)} /> เธฃเธฒเธเธฒ</label>
              <label className="tog"><input type="checkbox" checked={showName} onChange={e => setShowName(e.target.checked)} /> เธเธทเนเธญเธชเธดเธเธเนเธฒ</label>
            </div>
            ...
            <div style={{ background: 'rgba(200,0,0,0.07)', border: '1px solid rgba(200,0,0,0.2)', borderRadius: 7, padding: '10px 12px', fontSize: 11, color: 'rgba(255,255,255,0.5)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}><span>เธเธเธฒเธ”</span><span style={{ color: '#fff' }}>{currentSize.w} ร— {currentSize.h} px</span></div>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}><span>เธญเธฑเธ•เธฃเธฒเธชเนเธงเธ</span><span style={{ color: '#fff' }}>{sizeId}</span></div>
              <div style={{ display: 'flex', justifyContent: 'space-between' }}><span>เน€เธฅเธทเธญเธ</span><span style={{ color: '#c00', fontWeight: 700 }}>{selected.size} เธฃเธฒเธขเธเธฒเธฃ</span></div>
            </div>

            <button className="btn-r" style={{ width: '100%', padding: '13px', fontSize: 14 }} disabled={selected.size === 0 || exporting} onClick={doExport}>
              {exporting ? `โณ ${progress}` : `๐“ฅ Export JPEG (${selected.size})`}
            </button>
            {selected.size === 0 && <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.2)', textAlign: 'center' }}>เธ•เธดเนเธเน€เธฅเธทเธญเธเธเธฒเธฃเนเธ”เธเนเธญเธ</div>}
          </div>
        </div>
      </div>
